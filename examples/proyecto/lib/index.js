//CONTROL DE TODO EL DOM INSERSIONES EVENTOS ELIMINACIONES
// ESPECIE DE CONTROLADOR EN MVC
...
window.addEventListener("load", (ev) => {
  ...
  //Tod.all => retorna los todos del servicio web
  Todo.all().then((todos) => {
  ...
  let editInPlace = (node, todo, propertyName) => {
    node.addEventListener("click", (ev) => {
      ...
      //Finalizar edicion: Reemplazar el campo de texto por un nodo de vuelta
    });
  };
});
